...
const Banner = () => {
  return (
    <div>
      <section className="space-y-4 py-4 lg:py-8">
        ...
        <div className="flex items-center justify-center gap-2">
          <div className="flex items-center btn btn-outline">
            <img src={btnGP} alt="btn" />
            <button>Google Play</button>
          </div>
          <div className="flex items-center btn btn-outline">
            <img src={btnAS} alt="btn" />
      ...
      <section className="bg-[linear-gradient(125deg,#632EE3_5.68%,#9F62F2_88.38%)] text-white px-4  py-4 lg:py-8">
        <h2 className="text-2xl lg:text-3xl font-semibold text-center">Trusted by Millions, Built for You</h2>
